...
import { estimateGas, getEthLastPrice, getWalletTokens, WalletToken } from 'old/src/model/wallet';
import { ether, ParaswapToken, Quote, getExchangePrice } from 'old/src/model/token';
import { globalWalletState } from 'old/src/stores/WalletStore';
import { ExchangeState, globalExchangeState } from 'old/src/stores/ExchangeStore';
