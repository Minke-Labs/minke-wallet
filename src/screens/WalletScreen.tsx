    ...
    return (
        <View style={{flex: 1}}>
            ...
            <Card style={{padding: 20}}>
                ...
                <Button style={{marginBottom: 5}} mode={'contained'} onPress={onTransfer}>Transfer</Button>
                <Button style={{marginBottom: 5}} color={'red'} onPress={onDeleteWallet}>Delete</Button>
            </Card>
            <Snackbar onDismiss={() => snackbarVisible.set(false)} visible={snackbarVisible.value}>Address
                Copied</Snackbar>
        </View>
    )
}
