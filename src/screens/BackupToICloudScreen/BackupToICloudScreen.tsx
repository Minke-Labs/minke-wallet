...
import styles from './BackupToICloudScreens.styles';
import { useState } from '@hookstate/core';
import { globalWalletState } from '@stores/WalletStore';

const BackupToICloudScreen = () => {
	...
	const onSuccess = async () => {
		console.log('BackupCloudStep:: saving backup password');
	...
	return (
		<WelcomeLayout>
			...
			<View style={{ paddingHorizontal: 24 }}>
				...
				<Button title="Back up to iCloud" iconRight="cloudStroke" disabled={!isPasswordValid} />
			</View>
		</WelcomeLayout>
	);
};
